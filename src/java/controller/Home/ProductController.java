...
public class ProductController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(action.equalsIgnoreCase("productdetail")){
            ...
            productDAO c = new productDAO();
            Product product = c.getProductByID(product_id);
            int category_id = product.getCate().getCategory_id();
            List<Product> productByCategory = c.getProductByCategory(category_id);
            request.setAttribute("ProductData", product);
        ...
        if(action.equals("sort")){
            ...
            if(type.equals("low")){
            productDAO c = new productDAO();
            List<Product> productList = c.getProductLow();
            List<Category> category = c.getCategory();
            int page, numperpage = 9;
            int size = productList.size();
            int num = (size % 9 == 0 ? (size / 9) : ((size / 9)) + 1);//so trang
            ...
            if(type.equals("high")){
            productDAO c = new productDAO();
            List<Product> productList = c.getProductHigh();
            List<Category> category = c.getCategory();
            int page, numperpage = 9;
            int size = productList.size();
            int num = (size % 9 == 0 ? (size / 9) : ((size / 9)) + 1);//so trang
            ...
            if(type.equals("a-z")){
            productDAO c = new productDAO();
            List<Product> productList = c.getProductAZ();
            List<Category> category = c.getCategory();
            int page, numperpage = 9;
            int size = productList.size();
            int num = (size % 9 == 0 ? (size / 9) : ((size / 9)) + 1);//so trang
