                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="slider_content content_one">
                                ...
                                <p>Discover the Ultimate Tank Model - Gear Up for Action!</p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="slider_content content_two">
                                ...
                                <p>Explore Our Unique Battleship Model - Get Ready to Dive into Adventure!</p>
                                <a href="product">Discover Now</a>
                            </div>    
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="slider_content content_three">
                                ...
                                <p>Experience the Power of Flight: Introducing Our Unique Aircraft Model</p>
                                <a href="product">Discover Now</a>
                            </div>    
                        </div>
                    </div>
        ...
        <section class="product_section womens_product bottom">
            <div class="container">
                <div class="row">   
                    <div class="col-12">
                        <div class="section_title">
                            <h2>Mô hình thịnh hành</h2>
                            <p>Nhũng mô hình ấn tượng và bán chạy nhất</p>
                        </div>
                    </div> 
                </div>    
                <div class="product_area"> 
